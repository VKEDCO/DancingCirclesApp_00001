 ...
 * 
 * The activity defines an options menu with two items:
 * Synch Threads and Unsynch Threads. 
 * 
 * When the user presses Synch Threads, the activity starts four
 ...
 * 
 * When the user selects Unsynch Threads, the activity starts
